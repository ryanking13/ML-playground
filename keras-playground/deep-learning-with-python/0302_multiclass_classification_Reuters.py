...
def indices2sentence(indices):
    word_index_dict = keras.datasets.reuters.get_word_index()
...
def main():
    ...
    ) = keras.datasets.reuters.load_data(num_words=MAX_DIM)
    ...
    model.add(keras.layers.Dense(64, input_shape=(MAX_DIM,)))
