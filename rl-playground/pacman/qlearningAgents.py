...
class QLearningAgent(ReinforcementAgent):
    ...
    def getAction(self, state):
        ...
        # not_best_actions = legalActions.copy().remove(best_action)
    ...
    def update(self, state, action, nextState, reward):
        ...
        cur_state_value = self.q[state, action]
        calc = reward + (self.discount * next_state_value) - cur_state_value

        self.q[(state, action)] = cur_state_value + (self.alpha * calc)
